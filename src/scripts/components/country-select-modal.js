class CountrySelectModal extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._languagePicker = [
        ...
        { country: "CN", languages: [ { code:"EN", label: "English"} , { code:"ZH-CN", label: "简体中文"} ] },
        ...
        { country: "FR", languages: [ { code:"EN", label: "English"} ] },
        ...
        { country: "DE", languages: [ { code:"EN", label: "English"} ] },
        ...
        { country: "HK", languages: [ { code:"EN", label: "English"} , { code:"ZH-CN", label: "简体中文"} ] },
        { country: "HU", languages: [ { code:"EN", label: "English"} ] },
        { country: "IS", languages: [ { code:"EN", label: "English"} ] },
        { country: "IN", languages: [ { code:"EN", label: "English"} ] },
        ...
        { country: "MO", languages: [ { code:"EN", label: "English"} , { code:"ZH-CN", label: "简体中文"} ] },
        ...
        { country: "ES", languages: [ { code:"EN", label: "English"} ] },
        ...
        { country: "AE", languages: [ { code:"EN", label: "English"} , { code:"AR", label: "العربية"} ] },
